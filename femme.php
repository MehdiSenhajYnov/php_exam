            ...
            foreach ($AllArticlesinStock as $key => $value) {
                ...
                if (isset($likedarticles))
                {
                    if (!in_array($artId, $likedarticles)) {
                        echo "<a class='cardlikeimg' href='femme.php?likedpost=$artId'><img src='images/likeicon.png' alt='likeblank' /></a>";
                    } else {
                        echo "<a class='cardlikeimg' href='femme.php?dislikedpost=$artId'><img src='images/likeiconfull.png' alt='likefilled' /></a>";
                    }
                }
                echo "</div>";
                echo "</div>";
